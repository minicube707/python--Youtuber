...
#Fonction
def mouvement(planets, sun, resolution, x_camera, y_camera, num, max):
    ...
    if key[pygame.K_KP_MINUS] :
        if  Planet.SCALE - 1 / Planet.AU > 0:
            ...
            if resolution <= max  and resolution > max - 75:
    ...
    return resolution, x_camera, y_camera, num, max
...
def main():
    ...
    while run :
        ...
        #Mouvement
        resolution, x_camera, y_camera, num, max = mouvement(planets, sun, resolution, x_camera, y_camera, num, max)
