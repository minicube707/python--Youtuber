...
x, y = make_regression(n_samples=100, n_features=2, noise=7)
...
plt.title("Graphique à la fin du Machine Learning sur la premère feature")
plt.xlabel("Axe des X")
plt.ylabel("Axe des Y")
plt.legend()
...
plt.title("Graphique à la fin du Machine Learning sur la deuxième feature")
plt.xlabel("Axe des X")
plt.ylabel("Axe des Y")
plt.legend()
...
print("La fonction coût final vaut = ",cost_history[1000-1])
