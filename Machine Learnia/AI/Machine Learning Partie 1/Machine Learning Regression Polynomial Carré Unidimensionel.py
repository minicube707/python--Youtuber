...
def cost_function(X, y, theta):
    print(1/(2*len(y))*np.sum((Model(X, theta)-y))**2)
...
plt.scatter(x,Model(X,theta),c='r',label="Droite d'initialisation")
...
plt.scatter(x, prediction,c='r', label="Prediction du model")
