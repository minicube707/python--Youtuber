...
def patternRecognition():
    ...
    for eachPattern in patternAr:
        ...
        if howSim > 70:
            ...
            print(patForRec)
            print(eachPattern)
            print('predicted outcome', perfomanceAr[patdex])
    ...
    if patFound:
        ...
        predictedAvgOutcome = sum(predictedOutcomeAr) / len(predictedOutcomeAr)
        ...
        plt.scatter(40, realMouvement, c='#54fff7', s=25)
